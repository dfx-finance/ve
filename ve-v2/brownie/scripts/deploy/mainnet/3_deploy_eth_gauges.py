...
def main():
    ...
    deploy_gauge(gauge_logic, Ethereum.CADC_USDC_LP, "cadcUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.EURC_USDC_LP, "eurcUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.GBPT_USDC_LP, "gbptUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.GYEN_USDC_LP, "gyenUsdc", verify_contracts)
    # deploy_gauge(gauge_logic, Ethereum.NZDS_USDC_LP, "nzdsUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.TRYB_USDC_LP, "trybUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.XIDR_USDC_LP, "xidrUsdc", verify_contracts)
    deploy_gauge(gauge_logic, Ethereum.XSGD_USDC_LP, "xsgdUsdc", verify_contracts)
