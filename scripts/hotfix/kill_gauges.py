...
from scripts.helper import get_addresses, network_info, gas_strategy, PROXY_MULTISIG
...
def main():
    ...
    HARDHAT_ACCT.transfer(DEPLOY_ACCT,
    ...
    for label, gauge_addr in gauge_addresses:
        dfx_distributor.toggleGauge(gauge_addr, {'from': DEPLOY_ACCT, 'gas_price': gas_strategy})
