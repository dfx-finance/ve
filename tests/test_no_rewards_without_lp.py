...
def test_only_lp_rewarded(dfx, mock_lp_tokens, voting_escrow, gauge_controller, distributor, veboost_proxy, three_liquidity_gauges_v4, master_account):
    # two random users
    user_0 = accounts[4]
    user_1 = accounts[5]
    ...
    deposit_to_ve(dfx, voting_escrow, [user_0, user_1],
                  [1e21, 1e24], [100, 208], lock_timestamp)
    ...
    rewards = claim_rewards(
        euroc_usdc_gauge, addresses.DFX, users, master_account)
