...
def test_boosted_apr(dfx, mock_lp_tokens, distributor, gauge_controller, voting_escrow, veboost_proxy, three_liquidity_gauges_v4, master_account):
    # two random users
    user_0 = accounts[4]
    user_1 = accounts[5]
    ...
    mint_vedfx_and_vote(dfx, gauge_controller, voting_escrow,
                        three_liquidity_gauges_v4, euroc_usdc_gauge, user_0)
