...
PAIRS = [
    (existing.read_addr("cadcUsdcLp"), deployed.read_addr("cadcUsdcGauge")),
    (existing.read_addr("eurcUsdcLp"), deployed.read_addr("eurcUsdcGauge")),
    (existing.read_addr("gbptUsdcLp"), deployed.read_addr("gbptUsdcGauge")),
    (existing.read_addr("gyenUsdcLp"), deployed.read_addr("gyenUsdcGauge")),
    # (existing.read_addr("nzdsUsdcLp"), deployed.read_addr("nzdsUsdcGauge")),
    (existing.read_addr("trybUsdcLp"), deployed.read_addr("trybUsdcGauge")),
    (existing.read_addr("xidrUsdcLp"), deployed.read_addr("xidrUsdcGauge")),
    (existing.read_addr("xsgdUsdcLp"), deployed.read_addr("xsgdUsdcGauge")),
]
ARBITRUM_GAUGES = [
    existing.read_addr("arbitrumCadcUsdcRootGauge"),
    existing.read_addr("arbitrumGyenUsdcRootGauge"),
]
POLYGON_GAUGES = [
    existing.read_addr("polygonCadcUsdcRootGauge"),
    existing.read_addr("polygonNgncUsdcRootGauge"),
    existing.read_addr("polygonTrybUsdcRootGauge"),
    existing.read_addr("polygonXsgdUsdcRootGauge"),
]
